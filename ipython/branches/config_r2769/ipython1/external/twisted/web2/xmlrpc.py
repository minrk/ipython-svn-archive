# -*- test-case-name: ipython1.external.twisted.web2.test.test_xmlrpc -*-
#
...
# Sibling Imports
from ipython1.external.twisted.web2 import resource, stream
from ipython1.external.twisted.web2 import responsecode, http, http_headers
