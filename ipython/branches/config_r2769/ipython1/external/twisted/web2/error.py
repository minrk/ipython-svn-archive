...
"""
Default error output filter for ipython1.external.twisted.web2.
"""

from ipython1.external.twisted.web2 import stream, http_headers
from ipython1.external.twisted.web2.responsecode import *
