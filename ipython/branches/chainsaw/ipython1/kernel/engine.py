"""The Twisted core of the ipython engine.
...
parts of the engine.  Modified from ipython1.kernel1p.kernelcore.
"""
#*****************************************************************************
...
class EngineTCPProtocol(basic.LineReceiver):
    ...
    def handle_RESET(self, args):
        log.msg("Resettng the engine...")
        self.factory.reset()
        self.sendLine('RESET OK')
        self._reset()
        
    def handle_KILL(self, args):
        log.msg("Killing the engine...")
        reactor.stop()
...
class EngineTCPFactory(protocol.ClientFactory, EngineFactoryBase):
    protocol = EngineTCPProtocol
    ...
    def __init__(self, allow=[], notify=[]):
        ...
        EngineFactoryBase.__init__(self, allow, notify)
...
class EngineTCPFactoryGUI(protocol.ServerFactory, EngineFactoryBase):
    protocol = EngineTCPProtocol
...
class ThreadlessEngineTCPFactory(protocol.ServerFactory, EngineFactoryBase):
    protocol = EngineTCPProtocol
