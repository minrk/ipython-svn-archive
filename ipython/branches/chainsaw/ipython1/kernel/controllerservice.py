 ...
 * Review the usage of autogenerated methods in ControllerService.
...
class ControllerService(service.Service, results.NotifierParent):
    ...
    def setAutoMethods(self):
        ...
        WARNING:  This appears to not work for methods with arguements that
        have default values.  This needs to be reviewed.
        """
