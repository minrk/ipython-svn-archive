...
from ipython1.external.twisted.web2 import static, iweb, log, server, channel, vhost
from ipython1.external.twisted.web2.dav import static as dav_static
...
"""
    ...
    def opt_class(self, className):
        """A class that will be used to serve the root resource.  Must implement ipython1.external.twisted.web2.iweb.IResource and take no arguments.
        """
        if self['root']:
            raise usage.UsageError("You may only have one root resource.")
