...
from ipython1.external.twisted.web2 import stream as stream_mod, http, http_headers, responsecode
from ipython1.external.twisted.web2.channel import http as httpchan
from ipython1.external.twisted.web2.channel.http import PERSIST_NO_PIPELINE, PERSIST_PIPELINE
from ipython1.external.twisted.web2.client import interfaces
...
class HTTPClientProtocol(basic.LineReceiver, policies.TimeoutMixin, object):
    ...
    def submitRequest(self, request, closeAfter=True):
        ...
        @callback: L{ipython1.external.twisted.web2.http.Response} from the server.
        """
