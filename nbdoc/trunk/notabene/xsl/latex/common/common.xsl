...
</xsl:template><!-- ====================================================================== --><xsl:template name="is.section">
  <xsl:param name="node" select="."/>
  <xsl:choose>
...
</xsl:template><!-- ====================================================================== --><xsl:template name="section.level">
  <xsl:param name="node" select="."/>
  <xsl:choose>
    ...
    <xsl:when test="name($node)='refsect1' or                     name($node)='refsect2' or                     name($node)='refsect3' or                     name($node)='refsection' or                     name($node)='refsynopsisdiv'">
...
</xsl:template><!-- section.level --><xsl:template name="qanda.section.level">
...
</xsl:template><!-- Finds the total section depth of a section in a refentry --><xsl:template name="refentry.section.level">
  <xsl:param name="node" select="."/>
...
</xsl:template><!-- Finds the section depth of a refentry --><xsl:template name="refentry.level">
  <xsl:param name="node" select="."/>
...
</xsl:template><!-- ====================================================================== --><xsl:template name="select.mediaobject">
...
</xsl:template><!-- ====================================================================== --><xsl:template name="select.mediaobject.index">
  <xsl:param name="olist" select="imageobject|imageobjectco                      |videoobject|audioobject|textobject"/>
      ...
      <xsl:if test="$count &lt;= count($olist)">
        ...
        <xsl:variable name="useobject">
          <xsl:choose>
            ...
            <xsl:when test="name($object)='textobject' and $object/phrase                             and $object/@role='tex' and $stylesheet.result.type = 'fo'                             and $tex.math.in.alt != ''">
              <xsl:text>1</xsl:text> 
            </xsl:when>
            ...
            <xsl:when test="name($object)='textobject'                             and $object/ancestor::equation ">
...
</xsl:template><xsl:template name="is.acceptable.mediaobject">
...
</xsl:template><!-- ====================================================================== --><xsl:template name="check.id.unique">
...
</xsl:template><xsl:template name="check.idref.targets">
  <xsl:param name="linkend"/>
...
</xsl:template><!-- ====================================================================== --><!-- Procedure Step Numeration --><xsl:param name="procedure.step.numeration.formats" select="'1aiAI'"/><xsl:template name="procedure.step.numeration">
...
</xsl:template><!-- ====================================================================== --><!-- OrderedList Numeration --><xsl:template name="orderedlist-starting-number">
...
</xsl:template><!-- ====================================================================== --><!-- ItemizedList "Numeration" --><xsl:template name="next.itemsymbol">
...
</xsl:template><!-- ====================================================================== --><xsl:template name="copyright.years">
...
</xsl:template><!-- ====================================================================== --><xsl:template name="find.path.params">
  <xsl:param name="node" select="."/>
