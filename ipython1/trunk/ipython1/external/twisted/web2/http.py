# -*- test-case-name: ipython1.external.twisted.web2.test.test_http -*-
...
from ipython1.external.twisted.web2.stream import IByteStream
...
from ipython1.external.twisted.web2 import compat
