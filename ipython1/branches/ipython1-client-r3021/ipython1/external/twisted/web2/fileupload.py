...
from ipython1.external.twisted.web2.stream import IStream, FileStream, BufferedStream, readStream
from ipython1.external.twisted.web2.stream import generatorToStream, readAndDiscard
