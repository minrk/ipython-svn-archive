...
from ipython1.kernel.multienginexmlrpc import XMLRPCSynchronousMultiEngineClient
...
class SynchronousMultiEngineTestCase(DeferredTestCase, ISynchronousMultiEngineTestCase):
    ...
    def setUp(self):
        ...
        self.multiengine = XMLRPCSynchronousMultiEngineClient(('localhost',10105))
        self.engines = []
...
class FullTwoPhaseMultiEngineTestCase(DeferredTestCase,IFullTwoPhaseMultiEngineTestCase):
    ...
    def setUp(self):
        ...
        self.imultiengine_factory = IXMLRPCMultiEngineFactory(self.imultiengine)
        self.servers.append(reactor.listenTCP(10105, self.imultiengine_factory))
        multiengine = XMLRPCSynchronousMultiEngineClient(('localhost',10105))
        self.multiengine = me.IFullTwoPhaseMultiEngine(multiengine)
        self.engines = []
