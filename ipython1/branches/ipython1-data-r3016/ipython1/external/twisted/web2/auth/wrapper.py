# -*- test-case-name: ipython1.external.twisted.web2.test.test_httpauth -*-
...
class HTTPAuthResource(object):
    ...
    def __init__(self, wrappedResource, credentialFactories,
                 portal, interfaces):
        """
        @param wrappedResource: A L{ipython1.external.twisted.web2.iweb.IResource} to be returned 
