# -*- test-case-name: ipython1.external.twisted.web2.test.test_vhost -*-
...
# Sibling Imports
from ipython1.external.twisted.web2 import resource
from ipython1.external.twisted.web2 import responsecode
from ipython1.external.twisted.web2 import iweb
...
class NameVirtualHost(resource.Resource):
    ...
    def __init__(self, default=None):
        ...
        @param default: The default resource to be served when encountering an
            unknown hostname.
        @type default: L{ipython1.external.twisted.web2.iweb.IResource} or C{None}
        """
    ...
    def addHost(self, name, resrc):
        ...
        @param resrc: The L{ipython1.external.twisted.web2.iweb.IResource} to be served as the
            given hostname.
        @type resource: L{ipython1.external.twisted.web2.iweb.IResource}
        """
